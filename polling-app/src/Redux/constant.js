...
export const GetPoll_Request = "GetPoll_Request";
export const GetPoll_Success = "GetPoll_Success";
export const GetPoll_Error = "GetPoll_Error";


export const UpdatePoll_Request = "UpdatePoll_Request";
